// Blueprints Example — adapted from imgui-node-editor/examples/blueprints-example
// Compatibility shims added for ImGui::Spring/BeginHorizontal/EndHorizontal/BeginVertical/EndVertical

#define IMGUI_DEFINE_MATH_OPERATORS
#include "blueprints_example.h"
...
// ============================================================================
// Compatibility shims for removed ImGui layout API
// No-op implementations to avoid corrupting ImGui group/cursor state.
// ============================================================================
namespace ImGui {
    inline void BeginHorizontal(const char*, const ImVec2& = ImVec2(0,0), float = -1.0f) {}
    inline void BeginHorizontal(void*, const ImVec2& = ImVec2(0,0), float = -1.0f) {}
    inline void EndHorizontal() {}
    inline void BeginVertical(const char*, const ImVec2& = ImVec2(0,0), float = -1.0f) {}
    inline void BeginVertical(void*, const ImVec2& = ImVec2(0,0), float = -1.0f) {}
    inline void EndVertical() {}
    inline void Spring(float = 1.0f, float = -1.0f) {}
}

// ============================================================================
// Utility source includes
// ============================================================================
#include "../imgui-node-editor/examples/blueprints-example/utilities/drawing.cpp"
#include "../imgui-node-editor/examples/blueprints-example/utilities/widgets.cpp"
#include "../imgui-node-editor/examples/blueprints-example/utilities/builders.cpp"
...
// Texture stubs (not needed for node editor functionality)
static ImTextureID LoadTexture(const char*) { return (ImTextureID)0; }
static void DestroyTexture(ImTextureID) {}
static int GetTextureWidth(ImTextureID) { return 0; }
static int GetTextureHeight(ImTextureID) { return 0; }
...
# endif
    ...
    */
    ...
    ImTextureID          m_HeaderBackground = (ImTextureID)0;
    ImTextureID          m_SaveIcon = (ImTextureID)0;
    ImTextureID          m_RestoreIcon = (ImTextureID)0;
...
static Example* m_Example = nullptr;

void ShowBlueprintsExample(bool* p_open)
{
	if(!p_open)
	{
		return;
